...
# import sys
# sys.path.append("/data/sgc/cell_seg_49/pytorch_fnet-release_1/fnet/nn_modules/UCAP_3D/module")
...
class Net(pl.LightningModule):
    ...
    def forward(self, x):
        ...
        conv_3_1 = self.encoder_convs[2](conv_2_1)
    ...
    def _build_encoder(self):
        ...
        self.encoder_output_dim = [16, 16, 8, 8, 8, 2]
        self.encoder_output_atoms = [8, 8, 16, 32, 64, 128]
    ...
    def _build_decoder(self):
        ...
        if self.connection == "skip":
            self.decoder_in_channels = [2 * self.encoder_output_atoms[-1], 512, 256, 256, 128, 128,64]
